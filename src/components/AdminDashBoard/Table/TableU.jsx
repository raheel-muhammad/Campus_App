...
export default function TableU(props) {
    ...
    return (
        ...
        <>
            ...
            <TableContainer component={Paper}>
                ...
                <Table sx={{ minWidth: 500, minHeight: 475 }} aria-label="custom pagination table">
                    <TableHead>
                        ...
                        {(rowsPerPage > 0
                            ...
                            <TableRow key={row.name} style={{ verticalAlign: "top" }}>
                                ...
                                <TableCell style={{ minWidth: "160px" }} ><ViewJobsModalAdmin ListButtonText1={props.ListButtonText1} ListDilogTitle1={props.ListDilogTitle1}
                                    ...
                                    item={row} /></TableCell>
                                {/* {console.log("status=>", row.blocked)} */}
                                <TableCell>
                                    <Button
                                        size='small'
                                        className="ButtonText"
                                        disableElevation onClick={() =>
                                            BlockOrUnblockHandler(row.role, row, index + (page * rowsPerPage))} >
